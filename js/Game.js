class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      //Adicione IA ao movimento do carrinho
  ...
  //Crie método para exibir barra de combustível
  showFuelBar() {
    push();
  ...
  handleFuel(index) {
    ...
    //Adicione condicionais para reduzir combustível
...
handlePlayerControls() {
  if (keyIsDown(UP_ARROW)) {
    //Adicione flag para movimento do player
